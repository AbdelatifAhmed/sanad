...
export default function ReviewPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Submit profile details to companion update API
      ...
      // Clear local storage draft states
      localStorage.removeItem("onboarding_specialization");
      ...
      localStorage.removeItem("onboarding_availability");
      localStorage.removeItem("onboarding_emergency");
      localStorage.removeItem("onboarding_rate");
      ...
      console.warn("Server submit failed, showing visual completion:", err);
      // Fallback for standalone frontend demo
      setShowModal(true);
    } finally {
          ...
          <div className="bg-white rounded-3xl border border-sand-high p-8 md:p-10 custom-shadow space-y-8 text-left">
            <div>
              ...
              <p className="text-gray-500 text-sm md:text-base font-medium">
                Make sure all credentials, documents, and preferences are correct before submitting your companion profile.
              </p>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-[#fcf9f6] p-6 rounded-2xl border border-sand-high space-y-4">
                  ...
                  <div className="space-y-2.5 text-xs text-gray-600 font-medium">
                    <p><span className="text-gray-400">Name:</span> {user?.name || "Caregiver Professional"}</p>
                ...
                <div className="bg-[#fcf9f6] p-6 rounded-2xl border border-sand-high space-y-4">
                  ...
                  <hr className="border-sand-high" />
                  <div className="max-h-36 overflow-y-auto space-y-1.5 text-xs font-semibold text-gray-600">
                    {availability.length > 0 ? (
                      ...
                      <p className="text-gray-400 text-xs font-medium">No availability slots selected.</p>
                    )}
                    <div className="pt-2 flex justify-between text-[10px] text-gray-400">
                      <span>Emergency Care:</span>
                      <span className="font-bold text-teal-600">{emergencyCare ? "Available" : "Not Available"}</span>
                    </div>
                  </div>
                </div>
