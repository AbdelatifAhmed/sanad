...
const { sendProposal, getProposalsForJob, updateProposalStatus, getMyProposals } = require("../controllers/proposalController");
const { authenticate } = require("../middleware/authMiddleware");
const { authorizeRoles } = require("../middleware/RoleMiddleware");

router.post("/", authenticate, authorizeRoles("companion"), sendProposal);
router.get("/my-proposals", authenticate, authorizeRoles("companion"), getMyProposals);
