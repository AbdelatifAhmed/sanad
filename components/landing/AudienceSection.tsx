  ...
  return (
    <section className="py-24 bg-stitch-background px-margin-mobile md:px-margin-desktop font-stitch-body">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8">
        {/* For Families */}
        <div className="bg-white p-12 rounded-4xl shadow-soft flex flex-col justify-between hover:shadow-premium transition-shadow border border-stitch-outline/10">
          <div>
        ...
        {/* For Caregivers */}
        <div className="bg-stitch-on-surface text-white p-12 rounded-4xl shadow-soft flex flex-col justify-between hover:shadow-premium transition-shadow">
          <div>
