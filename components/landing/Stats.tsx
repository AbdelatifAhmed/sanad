      ...
      <div className="max-w-7xl mx-auto px-margin-mobile md:px-margin-desktop">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center text-stitch-on-primary">
          <div>
            ...
            <p className="text-white/80 text-sm font-medium">Verified Caregivers</p>
          </div>
          <div>
            <p className="text-4xl font-bold mb-1 font-stitch-display">12,000+</p>
            <p className="text-white/80 text-sm font-medium">Families Assisted</p>
          </div>
          <div>
            <p className="text-4xl font-bold mb-1 font-stitch-display">98%</p>
            <p className="text-white/80 text-sm font-medium">Satisfaction Rate</p>
          </div>
          <div>
            <p className="text-4xl font-bold mb-1 font-stitch-display">24/7</p>
            <p className="text-white/80 text-sm font-medium">Platform Support</p>
          </div>
        </div>
      </div>
    </section>
